...
class CacoERFeatureGenerator:
    ...
    def standardize(self, smiles: str) -> Chem.Mol | None:
    ...
    def process_smiles(
        ...
        for idx, smi in enumerate(smiles_list):
            ...
            try:
                ...
                if use_avalon:
                    avalon_fp = np.array(
                        pyAvalonTools.GetAvalonFP(mol, nBits=1024), dtype=np.float32
                    )
                else:
    ...
    def predict(self, smiles_list: list[str]) -> np.ndarray:
        ...
        try:
            ...
            if self.var_selector is not None:
                print("      Applying variance selector...")
