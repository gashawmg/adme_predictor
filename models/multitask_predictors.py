...
from core.descriptors import LegacyMPNNDescriptorCalculator
...
class BaseMultitaskPredictor:
    ...
    def __init__(
        self, group_name: str, target_list: list[str], model_dir: str, checkpoint_version="latest"
    ):
